...
public class ReservationDao {
    ...
    private final RowMapper<Reservation> rowMapper = (resultSet, rowNum) -> new Reservation(
            ...
            new Member(
                ...
                resultSet.getLong("member.password_id"),
    ...
    public List<Reservation> findAllByThemeIdAndDate(Long themeId, String date) {
        String sql = "SELECT reservation.id, reservation.schedule_id, reservation.member_id, schedule.id, schedule.theme_id, schedule.date, schedule.time, " +
                     "theme.id, theme.name, theme.desc, theme.price, " +
                     "member.id, member.password_id, member.username, member.phone, member.name " +
                "from reservation " +
